...
checkpoint:
  ...
  gray_areas_resolved:
    - topic: "pain category"
      decision: "Tarcie procesu nauki, paraliż decyzyjny rodzica i utrata motywacji dziecka."
    - topic: "core insight"
      decision: "Materiały muszą trafiać dokładnie w aktualny poziom dziecka, inaczej są nudne albo za trudne."
    - topic: "primary persona"
      decision: "Rodzic uczący własne dziecko czytania w domu."
    - topic: "access model"
      decision: "Logowanie do konta rodzica z zapisanym postępem dziecka."
    - topic: "role model"
      decision: "Jedna rola: rodzic zarządza materiałami i postępem dziecka."
    - topic: "mvp flow"
      decision: "Rodzic wybiera poziom dziecka, aplikacja generuje fiszki, rodzic akceptuje większość, dziecko ćwiczy zaakceptowany materiał w gotowym algorytmie powtórek."
    - topic: "timeline budget"
      decision: "Pierwsza wersja MVP ma zmieścić się w około 3 tygodniach pracy."
    - topic: "FR Socrates revisions"
      decision: "Zostawiono logowanie, dodano opcję niepewnego poziomu, ograniczono edycję fiszek do akceptacji/odrzucenia, zmieniono pomiar na prosty wskaźnik opanowania, a karty pracy przeniesiono poza MVP."
    - topic: "business rule"
      decision: "Aplikacja dobiera i dopuszcza do ćwiczeń tylko taki materiał czytelniczy, który pasuje do wybranego poziomu dziecka oraz został zaakceptowany przez rodzica."
    - topic: "non-functional requirements"
      decision: "Partia fiszek do akceptacji poniżej 10 sekund, sesja ćwiczeń poniżej 10 minut, produkt używalny na telefonie rodzica w aktualnych głównych przeglądarkach."
    - topic: "product framing"
      decision: "Aplikacja webowa dla małej skali, bez twardego deadline'u, budowana po godzinach."
    - topic: "non-goals"
      decision: "Bez sprawdzania głosem, bez pełnego edytora fiszek, bez budowania własnego algorytmu powtórek."
  frs_drafted: 7
...
- Automatyczne przygotowanie kart pracy zostaje przeniesione poza zakres MVP.
- Pełna edycja treści fiszek zostaje przeniesiona poza zakres MVP.
